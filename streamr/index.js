...
fluence.connect("0x4c9c53c3005a52d3468bb8a20fcb4c3ea76098ac", 31).then((s) => {
    s.invoke(deleteQuery).result().then((r) => console.log(r.asString()));

    s.invoke(createTableQuery)
